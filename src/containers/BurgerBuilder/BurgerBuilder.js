...
class BurgerBuilder extends Component {
    ...
    // constructor(props){
    //     super(props)     //method of calling state
    //     this.state = {
...
componentDidMount(){
    axios.get('https://react-my-burger-59922.firebaseio.com/ingredients.json')
    .then(response => {
 ...
 purchaseContinueHandler = () => {
    ...
    render(){
        ...
        for(let key in disabledInfo){
            disabledInfo[key] = disabledInfo[key] <= 0; //disabledInfo[key] is value of each quant of object item.
        }
